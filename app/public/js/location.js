...
var sizeArr = [
    { id: "0", name: "Select Size",value: -1},
    { id: "1", name: "1-20",value:"1-2" },
    { id: "2", name: "21-50",value:"21-50" },
    { id: "3", name: "51-100",value:"51-100" },
    { id: "4", name: "100up",value:"100up" }
];

var yearArr = [{id:0,name:"Select Establish Year",value:-1}];
var year = 2016;
for (var i = 1; i < 37; i++) {
...
// function populateCity(countryElementId, stateElementId, selected) {
...
// function populateCountries(countryElementId, stateElementId, selected) {
