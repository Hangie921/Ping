...
// db.members.drop()
// member.collection.insertMany(employees, function(err,r) {
...
//     assert.equal(5, r.insertedCount);
    ...
    // member.collection.insertMany(employees, function(m_err,m_r) {
    //     console.log(m_r);
    //     m_r.insertedIds.forEach(function(argument) {
    //         console.log("roke==="+r.insertedIds[0]);
    //         // body...
    //         member.findById(argument, function(err, user) {
